...
47 crore Indians borrow from digital lending apps. A loan advertised at "2% per month" routinely becomes 60–150% APR once processing fees (3–5%), insurance premiums (2–3%), GST on fees (18%), prepayment penalties, and late-fee compounding are factored in.

The loan agreement disclosing all of this is 12–20 pages of legal English. The borrower — often in financial distress, often semi-literate in English, often in Karnataka, UP, or Bihar — signs it without understanding what they agreed to.

RBI's Fair Practice Code (updated 2025) and Digital Lending Directions (2025) *require* lenders to disclose actual APR in a Key Fact Statement (KFS) before the borrower signs. Hundreds of apps violate this. Nobody can prove it — because computing the real APR from a 20-page legal PDF requires a Chartered Accountant.
